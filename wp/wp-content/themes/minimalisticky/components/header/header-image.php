...
<a href="<?php echo esc_url(get_theme_mod('header_left_button_link')) ?>" class="header-button-left">
<?php echo esc_html(get_theme_mod('header_left_button_text')) ?>
</a>
<?php endif; ?>

<?php if (get_theme_mod('header_right_button_text') ) : ?>
<a href="<?php echo esc_url(get_theme_mod('header_right_button_link')) ?>" class="header-button-right">
<?php echo esc_html(get_theme_mod('header_right_button_text')) ?>
</a>
<?php endif; ?>
...
<div class="front-menu-box group unsaturate">
  ...
  <?php wp_nav_menu( array( 
    ...
    'fallback_cb'       => false,
    'walker'            => new minimalisticky_front_page_walker(),
    'depth' => 1 
    ) ); 
    ?>

<?php
/**
 * minimalisticky Theme Customizer.
 *
 ...
 */
function minimalisticky_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
    $wp_customize->get_section('background_image')->title = __( 'Background', 'minimalisticky' );
    $wp_customize->get_section('header_image')->title = __( 'Header', 'minimalisticky' );
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_title_color', array(
        'label'       => __( 'Header Title Color', 'minimalisticky' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_tagline_color', array(
        'label'       => __( 'Header Tagline Color', 'minimalisticky' ),
        'section'     => 'header_image',
        'priority' => 1,
    ...
    $wp_customize->add_control( 'header_left_button_text', array(
        'label'    => __( "Left Header Button Text", 'minimalisticky' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );
    ...
    $wp_customize->add_control( 'header_left_button_link', array(
        'label'    => __( "Left Header Button Link", 'minimalisticky' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_left_button_background_color', array(
        'label'       => __( 'Left Header Button Background Color', 'minimalisticky' ),
        'section'     => 'header_image',
        'priority' => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_left_button_text_color', array(
        'label'       => __( 'Left Header Button Text Color', 'minimalisticky' ),
        'section'     => 'header_image',
        'priority' => 1,
    ...
    $wp_customize->add_control( 'header_right_button_text', array(
        'label'    => __( "Right Header Button Text", 'minimalisticky' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );
    ...
    $wp_customize->add_control( 'header_right_button_link', array(
        'label'    => __( "Right Header Button Link", 'minimalisticky' ),
        'section'  => 'header_image',
        'type'     => 'text',
        'priority' => 1,
        ) );
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_right_button_background_color', array(
        'label'       => __( 'Right Header Button Border Color', 'minimalisticky' ),
        'section'     => 'header_image',
        'priority' => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_right_button_text_color', array(
        'label'       => __( 'Right Header Button Text Color', 'minimalisticky' ),
        'section'     => 'header_image',
        'priority' => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_bg_color', array(
        'label'       => __( 'Header Background Color', 'minimalisticky' ),
        'section'     => 'header_image',
        'priority' => 1,
        'settings'    => 'header_bg_color',
        ) ) );
    $wp_customize->add_control( 'header_textcolor', array(
        'label'    => __( 'Header Text Color', 'minimalisticky' ),
        'section'  => 'head_colors',
        ) );
    ...
    $wp_customize->add_control(
        new WP_Customize_Control(
            ...
            array( 
                'label'         => __( 'Show sitename in menu bar?', 'minimalisticky' ),
                'type'          => 'checkbox',
...
//Navigation
    $wp_customize->add_section(
        'navigation_settings',
        array(
            'title' => __('Navigation', 'minimalisticky'),
            'priority' => 99,
            )
        );  
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'nav_bg', array(
        'label'       => __( 'Background Color', 'minimalisticky' ),
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'nav_link_color', array(
        'label'       => __( 'Link Color', 'minimalisticky' ),
        'section'     => 'navigation_settings',
        'priority' => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'nav_logo_color', array(
        'label'       => __( 'Logo Color', 'minimalisticky' ),
        'section'     => 'navigation_settings',
        'priority' => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'background_color', array(
        'label'       => __( 'Background Color', 'minimalisticky' ),
        'description' => __( 'Choose a color for the background.', 'minimalisticky' ),
...
//Sidebar 
    $wp_customize->add_section(
        'sidebar_settings',
        array(
            'title' => __('Sidebar ', 'minimalisticky'),
            'priority' => 99,
            )
        );  
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_headline', array(
        'label'       => __( 'Headline Color', 'minimalisticky' ),
        'section'     => 'sidebar_settings',
        'priority' => 1,
    ...
    $wp_customize->add_setting( 'sidebar_headline_border', array(
        'default'           => '#f19772', 
        'type'              => 'theme_mod',
        'sanitize_callback' => 'sanitize_hex_color',
        'transport'         => 'postMessage'
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_headline_border', array(
        'label'       => __( 'Headline Border Color', 'minimalisticky' ),
        'section'     => 'sidebar_settings',
        'priority' => 1,
        'settings'    => 'sidebar_headline_border',
        ) ) );
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_text', array(
        'label'       => __( 'Text Color', 'minimalisticky' ),
        'section'     => 'sidebar_settings',
        'priority' => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_button_bg', array(
        'label'       => __( 'Button Background Color', 'minimalisticky' ),
        'section'     => 'sidebar_settings',
        'priority' => 1,
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_button_text_color', array(
        'label'       => __( 'Button Text Color', 'minimalisticky' ),
        'section'     => 'sidebar_settings',
        'priority' => 1,
    ...
    /* ///////////////// SIDEBAR LAYOUT ////////////////// */
        ...
        $wp_customize->add_section( 'minimalisticky-options', array(
            'title'         => __( 'Theme Options', 'minimalisticky' ),
            'capability'    => 'edit_theme_options',
            'description'   => __( 'Change the default display options for the theme.', 'minimalisticky' ),
            ) );
        ...
        $wp_customize->add_setting( 'layout_setting',
            array(
                ...
                'type'              => 'theme_mod',
                'sanitize_callback' => 'minimalisticky_sanitize_layout',
                'transport'         => 'postMessage'
                ) );
        ...
        $wp_customize->add_control( 'layout_control',
            array(
                ...
                'type'              => 'radio',
                'label'             => __( 'Sidebar position', 'minimalisticky' ),
                'choices'           => array(
                    'no-sidebar'    => __( 'No sidebar', 'minimalisticky' ),
                    'sidebar-right' => __( 'Sidebar right', 'minimalisticky' ),
                    'sidebar-left'  => __( 'Sidebar left', 'minimalisticky' ),
                    ),
                'section'           => 'sidebar_settings'
                ) );
...
//			'transport'         => 'postMessage',
          ...
          $wp_customize->add_control( 'panel_' . $page_names[$i], array(
             ...
             'label'          => sprintf( __( '%s Page Content', 'minimalisticky' ), ucwords( $page_names[$i] ) ),
             'description'    => ( 0 !== $i ? '' : __( 'Select pages to feature in each area from the dropdowns. Add an image to a section by setting a featured image in the page editor. Empty sections will not be displayed.', 'minimalisticky' ) ),
             'section'        => 'static_front_page',
             'type'           => 'dropdown-pages',
             'allow_addition' => true,
             'active_callback' => 'minimalisticky_is_static_front_page',
             ) );

//		$wp_customize->selective_refresh->add_partial( 'panel_' . $page_names[$i], array(
//			'selector'            => '#' . $page_names[$i],
//			'render_callback'     => 'minimalisticky_front_page_section',
//			'container_inclusive' => true,
//		) );
      }

  }
  add_action( 'customize_register', 'minimalisticky_customize_register' );

/**
 * Return whether we're previewing the front page and it's a static page.
 */
function minimalisticky_is_static_front_page() {
 ...
 */
function minimalisticky_customize_preview_js() {
	wp_enqueue_script( 'minimalisticky_customizer', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), '20160507', true );
}
add_action( 'customize_preview_init', 'minimalisticky_customize_preview_js' );

/*
 * Sanitize layout options
 */

function minimalisticky_sanitize_layout ( $value ) {
 ...
 */
function minimalisticky_sanitize_checkbox( $checked ) {
    // Boolean check
    return ( ( isset( $checked ) && true == $checked ) ? true : false );
}


if(! function_exists('minimalisticky_get_user_input' ) ):
    function minimalisticky_get_user_input(){
        ?>
        <style type="text/css">
        ...
        <?php }
        add_action( 'wp_head', 'minimalisticky_get_user_input' );
        endif;
